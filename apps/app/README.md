...
| Экран | Описание |
|---|---|
| Home | Главная: «О нас», «Полезное», «Сегодня в клинике», «Рекомендуем», sticky «Позвонить» |
...
- [x] Haptic feedback на карточках главной
- [x] Прелоадер — зелёный spinner (без `@you-vet/cat`)
- [x] Featured + fallback последних статей; skeleton «Рекомендуем»
