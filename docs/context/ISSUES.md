...
**Деплой:** исправления SEC-01…03, SEC-05 в коммите `986aa35` на `work-tech`; на prod попадут после merge в `dev`.
...
1. Merge `work-tech` → `dev` (PR) — задеплоить server hardening на prod
2. PRD-01 — скрытие груминга в Mini App
3. INF-01 — CI на PR
4. SEC-07 — initData валидация
