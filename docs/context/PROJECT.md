...
| B3 | Заявки + резерв + антиспам | ✅ prod |
| B4 | Бот: `/link_staff`, уведомления | ✅ prod |
| C1 | Mini App запись | ✅ prod |
| Q1 | «Задать вопрос» → чат врачей | ✅ prod, миграция **017** |
| Admin polish | фото врача mobile, отпуск, услуги, пароли | ✅ prod 2026-06-09 |
